...
CREATE TABLE "User" (
    ...
    "photoUrl" TEXT NOT NULL DEFAULT 'https://raw.githubusercontent.com/capstone-first/Vegalicious-Avatar/main/personas-1686142027724.png',
...
CREATE TABLE "BookmarkRecipe" (
    ...
    CONSTRAINT "BookmarkRecipe_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "BookmarkRecipe_id_key" ON "BookmarkRecipe"("id");
...
-- AddForeignKey
ALTER TABLE "BookmarkRecipe" ADD CONSTRAINT "BookmarkRecipe_recipeId_fkey" FOREIGN KEY ("recipeId") REFERENCES "Recipe"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BookmarkRecipe" ADD CONSTRAINT "BookmarkRecipe_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
